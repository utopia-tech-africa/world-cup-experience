...
async function main() {
  ...
  const addonList = await prisma.addOn.findMany({ orderBy: { displayOrder: 'asc' } });
  const merchAddon = addonList.find((a) => a.category === 'merch');
  const transportAddon = addonList.find((a) => a.name === 'PHL Airport Shuttle');
  ...
  const bookingSeeds = [
    {
      ...
      totalAmount: 1325,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-1.pdf',
    ...
    },
    {
      ...
      totalAmount: 5150,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-2.pdf',
      bookingStatus: 'confirmed' as const,
      confirmedAt: new Date(),
      confirmedBy: admin.id,
      addonNames: ['Merch Bundle', 'PHL Airport Shuttle', 'Lunch/Dinner Meal Add-on'],
    },
    {
      ...
      addonsTotalPrice: 50,
      totalAmount: 700,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-3.pdf',
    ...
    },
    {
      ...
      totalAmount: 2680,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-4.pdf',
      bookingStatus: 'pending' as const,
      addonNames: ['Merch Bundle', 'PHL Airport Shuttle', 'Lunch/Dinner Meal Add-on'],
    },
    {
      ...
      addonsTotalPrice: 0,
      totalAmount: 1950,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-5.pdf',
      bookingStatus: 'confirmed' as const,
    ...
    },
    {
      ...
      totalAmount: 1400,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-6.pdf',
      bookingStatus: 'pending' as const,
      addonNames: ['PHL Airport Shuttle', 'Premium Match-Day Priority Transfers'],
    },
    {
      ...
      totalAmount: 7800,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-7.pdf',
      bookingStatus: 'confirmed' as const,
    ...
    },
    {
      ...
      addonsTotalPrice: 75,
      totalAmount: 1375,
      paymentProofUrl: 'https://res.cloudinary.com/example/sample-receipt-8.pdf',
      bookingStatus: 'rejected' as const,
  ...
  for (const seed of bookingSeeds) {
    const { addonNames, confirmedAt, confirmedBy, rejectionReason, ...bookingData } = seed;
    ...
    if (existing) {
      ...
      await prisma.bookingAddOn.deleteMany({ where: { bookingId: existing.id } });
    } else {
